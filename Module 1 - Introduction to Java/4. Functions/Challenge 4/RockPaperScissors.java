...
public class RockPaperScissors {
    public static void main(String[] args) {
        ...
        System.out.println("Are you ready? Write 'yes' if you are, 'no' if you aren't.");
    ...
    //Task 1: See if the user wants to play.
      ...
      switch (userReady) {
        case "yes": System.out.println("Great!");
          ...
          String result = result(userMove, computerMove);
          printResult(userMove, computerMove, result);
          break;
        case "no":
          System.out.println("Darn, maybe some other time then...!");
          System.exit(0);
