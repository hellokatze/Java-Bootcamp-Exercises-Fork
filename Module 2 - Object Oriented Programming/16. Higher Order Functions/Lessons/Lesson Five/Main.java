...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> upperUsernames = usernames.stream()
          ...
          //toList accumulates elements of the stream into a list
        ...
        // first argument is starting value for the reduction
        // second argument is BinaryOperator, reduce the stream by adding every single element inside of it (x) by y.
        ...
        String response = result == null ? "No we don't!" : "Yes we do!";
