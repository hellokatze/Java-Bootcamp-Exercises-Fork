...
public class Car {
    private String make;
    private int year;
    public enum TrafficLight { RED, GREEN, YELLOW }; // enums are static by default, and its constants are final.
    ...
    public void drive(TrafficLight trafficLight) {
        if (trafficLight == null) throw new IllegalArgumentException("Traffic light can't be null");
        switch (trafficLight) {
